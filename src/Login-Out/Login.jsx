...
const Login = () => {
    ...
    // const validate = () => {
    //     const userCaptaValue = captaRef.current.value;
    //     console.log(userCaptaValue)
    //     if (validateCaptcha(userCaptaValue) == true) {
    //         setDisabled(false)
    //     }
    // }
    return (
          ...
          justify-around items-center">
                  ...
                  z-0"
                    ...
                    <div className="w-full mx-auto px-20 flex-col items-center space-y-6">
                        <h1 className=" font-bold text-4xl font-sans">Simple App</h1>
                        <p className=" mt-1">The simplest app to use</p>
                        ...
                        <form className="bg-white rounded-md shadow-2xl p-5" onSubmit={handleLogin}>
                            ...
                            {/* <div className="form-control">
                                ...
                                <label className="label">
                                    <span className="label-text">Write the above cpatcha</span>
                                </label>
                            ...
                            <div className="flex justify-between mt-4">
                                ...
                                <Link to='/signup' href="#" className="text-xs ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Don't have an account? Pls signUp</Link>
                            </div>
